...
class Utilisateur
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Message::class, mappedBy="idutilisateur", orphanRemoval=true)
     */
    private $messages;

    /**
     * @ORM\OneToMany(targetEntity=Publication::class, mappedBy="idputilisateur")
     */
    ...
    public function addPublication(Publication $publication): self
    {
        if (!$this->publications->contains($publication)) {
            ...
            $publication->setIdputilisateur($this);
        }
    ...
    public function removePublication(Publication $publication): self
    {
        if ($this->publications->removeElement($publication)) {
            // set the owning side to null (unless already changed)
            if ($publication->getIdputilisateur() === $this) {
                $publication->setIdputilisateur(null);
            }
        }
